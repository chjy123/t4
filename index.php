 ...
 <div class="container pt-3">
        <div class="row text-center ">
            <div class="col-6 col-md-3 py-3">
                <a href="products.php#watch"> <img src="images/flower3.webp" class="img-fluid " alt="" style="border-radius:0.5rem">
            ...
            <div class="col-6 col-md-3 py-3 " >
                <a href="products.php#shirt"  >
                  <img src="images/p2.jpg" class="img-fluid zoom" alt="" style="border-radius:0.5rem" >
                     <div class="h5 pt-3 font-weight-bolder">
                        Cake
                     </div>
                  </a>
            ...
            <div class="col-6 col-md-3 py-3">
                <a href="products.php#shoes">
                 <img src="images/bear4.jpeg" class="img-fluid   " alt="" style="border-radius:0.5rem">
                <div class="h5 pt-3 font-weight-bolder">
                    Cear
                 </div>
             </a>
            ...
            <div class="col-6 col-md-3 py-3">
                <a href="products.php#headphones">
                 <img src="images/clothing (2).jpg" class="img-fluid  " alt="" style="border-radius:0.5rem">
                 <div class="h5 pt-3 font-weight-bolder">
                    Chocolate
                 </div>
              </div>
